...
bcu_wedge = DirichletBC(V, Constant((0, 0)), wedge)
bcp_outflow = DirichletBC(Q, Constant(0), outflow)
bcu = [bcu_inflow, bcu_walls, bcu_wedge]
bcp = [bcp_outflow]
...
file_u = File('navier_stokes_wedge/velocity.pvd')
file_p = File('navier_stokes_wedge/pressure.pvd')
